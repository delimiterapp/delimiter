...
Credit data comes from two sources: SDK response headers (real-time) and connected provider billing APIs (polled every 15–30 min). See [Credits](/docs/dashboard/credits) and [Connections](/docs/dashboard/connections) for details.
