      ...
      <nav className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="shine-hover-light hidden items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm text-text-secondary transition-colors hover:bg-surface hover:text-text-primary md:inline-flex"
          >
          ...
          <div className="relative md:hidden" ref={menuRef}>
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg p-2 text-text-secondary transition-colors hover:bg-surface hover:text-text-primary"
              aria-label="Menu"
            >
              {menuOpen ? (
          ...
          <ScrambleButton
            as="a"
            href="/sign-in"
            className="ml-1 inline-flex items-center gap-2 rounded-lg bg-text-primary px-4 py-1.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-text-primary/90 hover:shadow-md"
