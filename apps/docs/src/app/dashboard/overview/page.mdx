...
Credit data comes from two sources: SDK response headers (real-time) and connected provider billing APIs (polled every 15–30 min). See [Credits](/dashboard/credits) and [Connections](/dashboard/connections) for details.
