...
function CornerPlus({ className }: { className: string }) {
  return (
    <span className={`absolute text-border text-xs font-light select-none ${className}`}>+</span>
  )
}
...
export async function CodeBlock({
  ...
  return (
    <div className="relative px-2 py-2">
      <CornerPlus className="-left-0.5 -top-0.5" />
      <CornerPlus className="-right-0.5 -top-0.5" />
      <CornerPlus className="-bottom-0.5 -left-0.5" />
      <CornerPlus className="-bottom-0.5 -right-0.5" />
